...
assert homepage.allowedHosts == [ "lab.xavierchanth.xyz" "lab.xavierchanth.xyz:8443" ];
...
assert container.environment.HOMEPAGE_ALLOWED_HOSTS == "lab.xavierchanth.xyz,lab.xavierchanth.xyz:8443";
