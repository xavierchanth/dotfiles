...
assert builtins.attrNames gateway.routes == [ executorHostname homepageHostname planeHostname ];
...
assert lib.all (vhost: lib.hasInfix "tls internal" vhost.extraConfig) [ homepageVhost executorVhost planeVhost ];
